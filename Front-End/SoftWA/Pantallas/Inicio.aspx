<%@ Page Title="" Language="C#" MasterPageFile="~/Pantallas/MasterPages/PaginaMaster.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="SoftCiapasaWA.Pantallas.Inicio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%------------------------------MODIFIQUE TODO EL LA CAEGORIA DESTACADOS CON IMAGEN -------------%>
